...
main(int argc, char *argv[])
{
  ...
  int  i=0;
  int st = uptime();
  19:	e8 dc 03 00 00       	call   3fa <uptime>
  1e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  init();
  21:	e8 dc 03 00 00       	call   402 <init>
  int n_children = atoi(argv[1]);
  26:	83 ec 0c             	sub    $0xc,%esp
  29:	ff 76 04             	pushl  0x4(%esi)
  2c:	e8 bf 02 00 00       	call   2f0 <atoi>
  if(argc<2)
  31:	83 c4 10             	add    $0x10,%esp
  34:	83 fb 01             	cmp    $0x1,%ebx
  37:	0f 8e b4 00 00 00    	jle    f1 <main+0xf1>
  {
  ...
  43:	7f 12                	jg     57 <main+0x57>
  45:	eb 65                	jmp    ac <main+0xac>
  47:	89 f6                	mov    %esi,%esi
  49:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  50:	83 c3 01             	add    $0x1,%ebx
  53:	39 de                	cmp    %ebx,%esi
  55:	74 46                	je     9d <main+0x9d>
  {
    int pid = fork();
  57:	e8 fe 02 00 00       	call   35a <fork>
    if(pid==0)
  ...
  60:	bb 10 27 00 00       	mov    $0x2710,%ebx
  65:	e8 90 03 00 00       	call   3fa <uptime>
  6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(int i=0;i<10000;i++)
    {
      //printf(1,"%d\n",i);
      int t = my_futex_lock();
  70:	e8 a5 03 00 00       	call   41a <my_futex_lock>
      tot_time+=t;
      //int st = uptime();
      //printf(1,"%d\n",i);
      int g = get();
  75:	e8 90 03 00 00       	call   40a <get>
      set(g+1);
  7a:	83 ec 0c             	sub    $0xc,%esp
  7d:	83 c0 01             	add    $0x1,%eax
  80:	50                   	push   %eax
  81:	e8 8c 03 00 00       	call   412 <set>

      //printf(1,"%d\n",i );
      my_unlock();
  86:	e8 9f 03 00 00       	call   42a <my_unlock>
    for(int i=0;i<10000;i++)
  ...
  93:	e8 62 03 00 00       	call   3fa <uptime>
    //int end = uptime();
    //end = (end-st)*10;
  ...
  9f:	90                   	nop
  a0:	83 c7 01             	add    $0x1,%edi
  wait();
  a3:	e8 c2 02 00 00       	call   36a <wait>
  for(int i=0;i<n_children;i++)
  a8:	39 df                	cmp    %ebx,%edi
  aa:	75 f4                	jne    a0 <main+0xa0>
  int g = get();
  ac:	e8 59 03 00 00       	call   40a <get>
  b1:	89 c3                	mov    %eax,%ebx
  printf(1,"Statistics for program with %d children using futex locks is as follows :\n",n_children);
  b3:	50                   	push   %eax
  b4:	56                   	push   %esi
  b5:	68 68 08 00 00       	push   $0x868
  ba:	6a 01                	push   $0x1
  bc:	e8 1f 04 00 00       	call   4e0 <printf>
  printf(1,"Final value of the shared counter is %d\n",g);
  c1:	83 c4 0c             	add    $0xc,%esp
  c4:	53                   	push   %ebx
  c5:	68 b4 08 00 00       	push   $0x8b4
  ca:	6a 01                	push   $0x1
  cc:	e8 0f 04 00 00       	call   4e0 <printf>
  int end = uptime() - st;
  d1:	e8 24 03 00 00       	call   3fa <uptime>
  d6:	2b 45 e4             	sub    -0x1c(%ebp),%eax
  end = end *10;
  printf(1,"Total execution time in milliseconds is %d\n",end);
  d9:	83 c4 0c             	add    $0xc,%esp
  end = end *10;
  dc:	6b c0 0a             	imul   $0xa,%eax,%eax
  printf(1,"Total execution time in milliseconds is %d\n",end);
  df:	50                   	push   %eax
  e0:	68 e0 08 00 00       	push   $0x8e0
  e5:	6a 01                	push   $0x1
 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 14 09 00 00 	movzbl 0x914(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 0c 09 00 00       	mov    $0x90c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 c4 0b 00 00       	mov    %eax,0xbc4
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 c4 0b 00 00       	mov    %eax,0xbc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 c4 0b 00 00    	cmp    %eax,0xbc4
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 c4 0b 00 00 c8 	movl   $0xbc8,0xbc4
 807:	0b 00 00 
 80a:	c7 05 c8 0b 00 00 c8 	movl   $0xbc8,0xbc8
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 c8 0b 00 00       	mov    $0xbc8,%eax
 819:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 820:	00 00 00 
