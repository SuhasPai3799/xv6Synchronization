...
main(int argc, char *argv[])
{
  ...
  11:	c7 45 e8 88 07 00 00 	movl   $0x788,-0x18(%ebp)
  18:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  char *argv_2[] = {"race_cond",0}; 
  1f:	c7 45 f0 90 07 00 00 	movl   $0x790,-0x10(%ebp)
  26:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  init();
  2d:	e8 30 03 00 00       	call   362 <init>
  int pid = fork();
  32:	e8 83 02 00 00       	call   2ba <fork>
  if(pid == 0)
  37:	85 c0                	test   %eax,%eax
  39:	74 1d                	je     58 <main+0x58>
    exec("my_prog",argv_1);
  ...
  40:	50                   	push   %eax
  41:	68 90 07 00 00       	push   $0x790
  46:	e8 af 02 00 00       	call   2fa <exec>
  ...
  57:	c3                   	ret    
    exec("my_prog",argv_1);
  58:	8d 45 e8             	lea    -0x18(%ebp),%eax
  5b:	52                   	push   %edx
  5c:	52                   	push   %edx
  5d:	50                   	push   %eax
  5e:	68 88 07 00 00       	push   $0x788
  63:	e8 92 02 00 00       	call   2fa <exec>
  68:	83 c4 10             	add    $0x10,%esp
  6b:	eb e1                	jmp    4e <main+0x4e>
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
