...
_race_cond:     file format elf32-i386
  ...
  15:	31 f6                	xor    %esi,%esi
{
  17:	83 ec 0c             	sub    $0xc,%esp
    int real_time = uptime();
  1a:	e8 3b 03 00 00       	call   35a <uptime>
  1f:	90                   	nop
  for(int i=0;i<10000;i++)
  {
    //printf(1,"%d\n",i);
    int t = my_futex_lock();
  20:	e8 55 03 00 00       	call   37a <my_futex_lock>
    tot_time+=t;
  25:	01 c6                	add    %eax,%esi
    //int st = uptime();
    //printf(1,"%d\n",i);
    int g = get();
  27:	e8 3e 03 00 00       	call   36a <get>
    set(g+1);
  2c:	83 ec 0c             	sub    $0xc,%esp
  2f:	83 c0 01             	add    $0x1,%eax
  32:	50                   	push   %eax
  33:	e8 3a 03 00 00       	call   372 <set>

    //printf(1,"%d\n",i );
    my_unlock();
  38:	e8 4d 03 00 00       	call   38a <my_unlock>
  for(int i=0;i<10000;i++)
  3d:	83 c4 10             	add    $0x10,%esp
  40:	83 eb 01             	sub    $0x1,%ebx
...
0000038a <my_unlock>:
SYSCALL(my_unlock)
 38a:	b8 1a 00 00 00       	mov    $0x1a,%eax
 38f:	cd 40                	int    $0x40
 391:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb c4 07 00 00       	mov    $0x7c4,%ebx
        while(*s != 0){
 ...
 611:	a1 78 0a 00 00       	mov    0xa78,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 78 0a 00 00    	mov    0xa78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 78 0a 00 00    	cmp    %eax,0xa78
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 78 0a 00 00    	mov    0xa78,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 78 0a 00 00    	mov    %edx,0xa78
}
 ...
 767:	0a 00 00 
 76a:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
 779:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 780:	00 00 00 
