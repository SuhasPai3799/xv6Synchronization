...
main(int argc, char *argv[])
{
  ...
  23:	50                   	push   %eax
  24:	e8 29 03 00 00       	call   352 <set>
  for(int i=0;i<10000;i++)
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 74 07 00 00 	movzbl 0x774(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 6c 07 00 00       	mov    $0x76c,%ebx
        while(*s != 0){
 ...
 5e1:	a1 1c 0a 00 00       	mov    0xa1c,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 1c 0a 00 00       	mov    %eax,0xa1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 737:	0a 00 00 
 73a:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 741:	0a 00 00 
    base.s.size = 0;
 744:	b8 20 0a 00 00       	mov    $0xa20,%eax
 749:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 750:	00 00 00 
