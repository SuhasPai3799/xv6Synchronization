...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 fb 79 10 80 	movl   $0x801079fb,(%esp)
...
80100916:	e8 05 36 00 00       	call   80103f20 <wakeup>
...
80100997:	e9 64 36 00 00       	jmp    80104000 <procdump>
...
80101ec8:	68 d6 77 10 80       	push   $0x801077d6
...
801020f1:	e8 2a 1e 00 00       	call   80103f20 <wakeup>
...
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 06 12 00 00       	call   80103f20 <wakeup>
    release(&log.lock);
...
80102d40:	e8 db 11 00 00       	call   80103f20 <wakeup>
  release(&log.lock);
...
80102e62:	e8 09 2a 00 00       	call   80105870 <idtinit>
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 d5 3a 00 00       	call   80106960 <switchkvm>
  seginit();
80102e8b:	e8 40 3a 00 00       	call   801068d0 <seginit>
  lapicinit();
...
80102ec1:	e8 6a 3f 00 00       	call   80106e30 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 fb 39 00 00       	call   801068d0 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 b7 2c 00 00       	call   80105ba0 <uartinit>
  pinit();         // process table
80102ee9:	e8 32 08 00 00       	call   80103720 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 fd 28 00 00       	call   801057f0 <tvinit>
  binit();         // buffer cache
...
801033c4:	e8 57 0b 00 00       	call   80103f20 <wakeup>
...
80103454:	e8 c7 0a 00 00       	call   80103f20 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103459:	5a                   	pop    %edx
8010345a:	59                   	pop    %ecx
...
801034e3:	e8 38 0a 00 00       	call   80103f20 <wakeup>
  release(&p->lock);
...
801035d7:	e8 44 09 00 00       	call   80103f20 <wakeup>
  release(&p->lock);
...
8010364f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103655:	e8 a6 0d 00 00       	call   80104400 <release>
...
80103677:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010367a:	c7 40 14 d7 57 10 80 	movl   $0x801057d7,0x14(%eax)
  p->context = (struct context*)sp;
...
80103689:	e8 c2 0d 00 00       	call   80104450 <memset>
...
801036b2:	e8 49 0d 00 00       	call   80104400 <release>
}
...
80103726:	68 b5 75 10 80       	push   $0x801075b5
...
801037a0:	68 bc 75 10 80       	push   $0x801075bc
...
80103823:	e8 88 35 00 00       	call   80106db0 <setupkvm>
...
80103841:	e8 4a 32 00 00       	call   80106a90 <inituvm>
...
801038af:	68 e5 75 10 80       	push   $0x801075e5
801038b4:	50                   	push   %eax
801038b5:	e8 76 0d 00 00       	call   80104630 <safestrcpy>
  p->cwd = namei("/");
801038ba:	c7 04 24 ee 75 10 80 	movl   $0x801075ee,(%esp)
...
801038f3:	68 cc 75 10 80       	push   $0x801075cc
...
8010392c:	e8 4f 30 00 00       	call   80106980 <switchuvm>
  return 0;
...
8010394a:	e8 81 32 00 00       	call   80106bd0 <allocuvm>
...
8010396a:	e8 91 33 00 00       	call   80106d00 <deallocuvm>
...
801039b8:	e8 c3 34 00 00       	call   80106e80 <copyuvm>
...
80103af0:	e8 8b 2e 00 00       	call   80106980 <switchuvm>
...
80103b95:	e8 f1 0a 00 00       	call   8010468b <swtch>
  mycpu()->intena = intena;
...
80103be6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103be9:	e8 82 06 00 00       	call   80104270 <pushcli>
  c = mycpu();
80103bee:	e8 4d fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103bf3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bf9:	e8 b2 06 00 00       	call   801042b0 <popcli>
  if(curproc == initproc)
...
80103c52:	e8 e9 06 00 00       	call   80104340 <acquire>
...
80103c68:	05 88 00 00 00       	add    $0x88,%eax
80103c6d:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103c72:	73 1e                	jae    80103c92 <exit+0xb2>
    if(p->state == SLEEPING && p->chan == chan)
80103c74:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103c78:	75 ee                	jne    80103c68 <exit+0x88>
80103c7a:	3b 50 20             	cmp    0x20(%eax),%edx
80103c7d:	75 e9                	jne    80103c68 <exit+0x88>
      p->state = RUNNABLE;
80103c7f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c86:	05 88 00 00 00       	add    $0x88,%eax
80103c8b:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103c90:	72 e2                	jb     80103c74 <exit+0x94>
      p->parent = initproc;
80103c92:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c98:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103c9d:	eb 0f                	jmp    80103cae <exit+0xce>
80103c9f:	90                   	nop
80103ca0:	81 c2 88 00 00 00    	add    $0x88,%edx
80103ca6:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
80103cac:	73 3a                	jae    80103ce8 <exit+0x108>
    if(p->parent == curproc){
80103cae:	39 72 14             	cmp    %esi,0x14(%edx)
80103cb1:	75 ed                	jne    80103ca0 <exit+0xc0>
      if(p->state == ZOMBIE)
80103cb3:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103cb7:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103cba:	75 e4                	jne    80103ca0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cbc:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103cc1:	eb 11                	jmp    80103cd4 <exit+0xf4>
80103cc3:	90                   	nop
80103cc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cc8:	05 88 00 00 00       	add    $0x88,%eax
80103ccd:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103cd2:	73 cc                	jae    80103ca0 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80103cd4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103cd8:	75 ee                	jne    80103cc8 <exit+0xe8>
80103cda:	3b 48 20             	cmp    0x20(%eax),%ecx
...
80103ce8:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103cef:	e8 4c fe ff ff       	call   80103b40 <sched>
  panic("zombie exit");
80103cf4:	83 ec 0c             	sub    $0xc,%esp
80103cf7:	68 31 76 10 80       	push   $0x80107631
80103cfc:	e8 8f c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d01:	83 ec 0c             	sub    $0xc,%esp
80103d04:	68 24 76 10 80       	push   $0x80107624
...
80103d1c:	e8 1f 06 00 00       	call   80104340 <acquire>
  pushcli();
80103d21:	e8 4a 05 00 00       	call   80104270 <pushcli>
  c = mycpu();
80103d26:	e8 15 fa ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d2b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d31:	e8 7a 05 00 00       	call   801042b0 <popcli>
...
80103d6c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d6f:	e8 fc 04 00 00       	call   80104270 <pushcli>
  c = mycpu();
80103d74:	e8 c7 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d79:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d7f:	e8 2c 05 00 00       	call   801042b0 <popcli>
  if(p == 0)
...
80103da0:	e8 9b 05 00 00       	call   80104340 <acquire>
    release(lk);
...
80103ddb:	5d                   	pop    %ebp
    acquire(lk);
80103ddc:	e9 5f 05 00 00       	jmp    80104340 <acquire>
...
80103e09:	68 43 76 10 80       	push   $0x80107643
80103e0e:	e8 7d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e13:	83 ec 0c             	sub    $0xc,%esp
80103e16:	68 3d 76 10 80       	push   $0x8010763d
...
80103e24:	53                   	push   %ebx
  pushcli();
80103e25:	e8 46 04 00 00       	call   80104270 <pushcli>
  c = mycpu();
80103e2a:	e8 11 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103e2f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e35:	e8 76 04 00 00       	call   801042b0 <popcli>
  acquire(&ptable.lock);
80103e3a:	83 ec 0c             	sub    $0xc,%esp
80103e3d:	68 20 2d 11 80       	push   $0x80112d20
80103e42:	e8 f9 04 00 00       	call   80104340 <acquire>
80103e47:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103e4a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e4c:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103e51:	eb 13                	jmp    80103e66 <wait+0x46>
80103e53:	90                   	nop
80103e54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e58:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103e5e:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103e64:	73 1e                	jae    80103e84 <wait+0x64>
      if(p->parent != curproc)
80103e66:	39 73 14             	cmp    %esi,0x14(%ebx)
80103e69:	75 ed                	jne    80103e58 <wait+0x38>
      if(p->state == ZOMBIE){
80103e6b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103e6f:	74 37                	je     80103ea8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e71:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
80103e77:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e7c:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103e82:	72 e2                	jb     80103e66 <wait+0x46>
    if(!havekids || curproc->killed){
80103e84:	85 c0                	test   %eax,%eax
80103e86:	74 76                	je     80103efe <wait+0xde>
80103e88:	8b 46 24             	mov    0x24(%esi),%eax
80103e8b:	85 c0                	test   %eax,%eax
80103e8d:	75 6f                	jne    80103efe <wait+0xde>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103e8f:	83 ec 08             	sub    $0x8,%esp
80103e92:	68 20 2d 11 80       	push   $0x80112d20
80103e97:	56                   	push   %esi
80103e98:	e8 c3 fe ff ff       	call   80103d60 <sleep>
    havekids = 0;
80103e9d:	83 c4 10             	add    $0x10,%esp
80103ea0:	eb a8                	jmp    80103e4a <wait+0x2a>
80103ea2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        kfree(p->kstack);
80103ea8:	83 ec 0c             	sub    $0xc,%esp
80103eab:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
80103eae:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103eb1:	e8 5a e4 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
80103eb6:	5a                   	pop    %edx
...
80103eba:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ec1:	e8 6a 2e 00 00       	call   80106d30 <freevm>
        release(&ptable.lock);
80103ec6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103ecd:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103ed4:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103edb:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103edf:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103ee6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103eed:	e8 0e 05 00 00       	call   80104400 <release>
        return pid;
80103ef2:	83 c4 10             	add    $0x10,%esp
}
80103ef5:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103ef8:	89 f0                	mov    %esi,%eax
80103efa:	5b                   	pop    %ebx
80103efb:	5e                   	pop    %esi
80103efc:	5d                   	pop    %ebp
80103efd:	c3                   	ret    
...
80103efe:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80103f01:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f06:	68 20 2d 11 80       	push   $0x80112d20
80103f0b:	e8 f0 04 00 00       	call   80104400 <release>
      return -1;
80103f10:	83 c4 10             	add    $0x10,%esp
80103f13:	eb e0                	jmp    80103ef5 <wait+0xd5>
...
80103f2f:	e8 0c 04 00 00       	call   80104340 <acquire>
80103f34:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f37:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103f3c:	eb 0e                	jmp    80103f4c <wakeup+0x2c>
80103f3e:	66 90                	xchg   %ax,%ax
80103f40:	05 88 00 00 00       	add    $0x88,%eax
80103f45:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103f4a:	73 1e                	jae    80103f6a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
...
80103f57:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f5e:	05 88 00 00 00       	add    $0x88,%eax
80103f63:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103f68:	72 e2                	jb     80103f4c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
80103f6a:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103f71:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103f74:	c9                   	leave  
  release(&ptable.lock);
80103f75:	e9 86 04 00 00       	jmp    80104400 <release>
...
80103f8f:	e8 ac 03 00 00       	call   80104340 <acquire>
80103f94:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f97:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103f9c:	eb 0e                	jmp    80103fac <kill+0x2c>
80103f9e:	66 90                	xchg   %ax,%ax
80103fa0:	05 88 00 00 00       	add    $0x88,%eax
80103fa5:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103faa:	73 34                	jae    80103fe0 <kill+0x60>
    if(p->pid == pid){
...
80103fb5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
80103fbc:	75 07                	jne    80103fc5 <kill+0x45>
        p->state = RUNNABLE;
80103fbe:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80103fc5:	83 ec 0c             	sub    $0xc,%esp
80103fc8:	68 20 2d 11 80       	push   $0x80112d20
80103fcd:	e8 2e 04 00 00       	call   80104400 <release>
      return 0;
80103fd2:	83 c4 10             	add    $0x10,%esp
80103fd5:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
80103fe3:	68 20 2d 11 80       	push   $0x80112d20
80103fe8:	e8 13 04 00 00       	call   80104400 <release>
  return -1;
...
8010401b:	68 fb 79 10 80       	push   $0x801079fb
80104020:	e8 3b c6 ff ff       	call   80100660 <cprintf>
80104025:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104028:	81 c3 88 00 00 00    	add    $0x88,%ebx
8010402e:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80104034:	0f 83 86 00 00 00    	jae    801040c0 <procdump+0xc0>
    if(p->state == UNUSED)
8010403a:	8b 43 0c             	mov    0xc(%ebx),%eax
8010403d:	85 c0                	test   %eax,%eax
8010403f:	74 e7                	je     80104028 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104041:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104044:	ba 54 76 10 80       	mov    $0x80107654,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104049:	77 11                	ja     8010405c <procdump+0x5c>
8010404b:	8b 14 85 b4 76 10 80 	mov    -0x7fef894c(,%eax,4),%edx
      state = "???";
80104052:	b8 54 76 10 80       	mov    $0x80107654,%eax
80104057:	85 d2                	test   %edx,%edx
80104059:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010405c:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010405f:	50                   	push   %eax
80104060:	52                   	push   %edx
80104061:	ff 73 10             	pushl  0x10(%ebx)
80104064:	68 58 76 10 80       	push   $0x80107658
80104069:	e8 f2 c5 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010406e:	83 c4 10             	add    $0x10,%esp
80104071:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80104075:	75 a1                	jne    80104018 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104077:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010407a:	83 ec 08             	sub    $0x8,%esp
8010407d:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104080:	50                   	push   %eax
80104081:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104084:	8b 40 0c             	mov    0xc(%eax),%eax
80104087:	83 c0 08             	add    $0x8,%eax
8010408a:	50                   	push   %eax
8010408b:	e8 90 01 00 00       	call   80104220 <getcallerpcs>
...
801040a5:	83 c7 04             	add    $0x4,%edi
801040a8:	52                   	push   %edx
801040a9:	68 a1 70 10 80       	push   $0x801070a1
801040ae:	e8 ad c5 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801040b3:	83 c4 10             	add    $0x10,%esp
801040b6:	39 fe                	cmp    %edi,%esi
801040b8:	75 de                	jne    80104098 <procdump+0x98>
801040ba:	e9 59 ff ff ff       	jmp    80104018 <procdump+0x18>
801040bf:	90                   	nop
  }
}
...
801040c6:	5d                   	pop    %ebp
801040c7:	c3                   	ret    
801040c8:	66 90                	xchg   %ax,%ax
801040ca:	66 90                	xchg   %ax,%ax
801040cc:	66 90                	xchg   %ax,%ax
...
801040da:	68 cc 76 10 80       	push   $0x801076cc
...
801042f5:	68 d7 76 10 80       	push   $0x801076d7
801042fa:	e8 91 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
801042ff:	83 ec 0c             	sub    $0xc,%esp
80104302:	68 ee 76 10 80       	push   $0x801076ee
...
801043e7:	68 f5 76 10 80       	push   $0x801076f5
...
8010443c:	68 fd 76 10 80       	push   $0x801076fd
...
80104857:	83 fa 1a             	cmp    $0x1a,%edx
8010485a:	77 1c                	ja     80104878 <syscall+0x38>
8010485c:	8b 14 85 40 77 10 80 	mov    -0x7fef88c0(,%eax,4),%edx
...
80104880:	68 05 77 10 80       	push   $0x80107705
...
801049d4:	68 cc 77 10 80       	push   $0x801077cc
...
801049ec:	68 cb 77 10 80       	push   $0x801077cb
...
80104a05:	68 bf 77 10 80       	push   $0x801077bf
...
80104a1a:	68 ce 77 10 80       	push   $0x801077ce
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 b0 77 10 80       	push   $0x801077b0
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 cc 77 10 80       	push   $0x801077cc
...
80104e34:	68 cb 77 10 80       	push   $0x801077cb
...
80105570:	68 a0 4f 11 80       	push   $0x80114fa0
...
8010557d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105580:	8b 1d e0 57 11 80    	mov    0x801157e0,%ebx
  while(ticks - ticks0 < n){
...
80105593:	68 a0 4f 11 80       	push   $0x80114fa0
80105598:	68 e0 57 11 80       	push   $0x801157e0
8010559d:	e8 be e7 ff ff       	call   80103d60 <sleep>
  while(ticks - ticks0 < n){
801055a2:	a1 e0 57 11 80       	mov    0x801157e0,%eax
...
801055c0:	68 a0 4f 11 80       	push   $0x80114fa0
...
801055e3:	68 a0 4f 11 80       	push   $0x80114fa0
...
80105604:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105607:	68 a0 4f 11 80       	push   $0x80114fa0
8010560c:	e8 2f ed ff ff       	call   80104340 <acquire>
  xticks = ticks;
80105611:	8b 1d e0 57 11 80    	mov    0x801157e0,%ebx
  release(&tickslock);
80105617:	c7 04 24 a0 4f 11 80 	movl   $0x80114fa0,(%esp)
...
80105633:	83 ec 10             	sub    $0x10,%esp
  glob_counter = 0;
80105636:	c7 05 94 4f 11 80 00 	movl   $0x0,0x80114f94
8010563d:	00 00 00 
  initlock(&counter_lock, "counter_lock");
80105640:	68 11 78 10 80       	push   $0x80107811
80105645:	68 60 4f 11 80       	push   $0x80114f60
8010564a:	e8 b1 eb ff ff       	call   80104200 <initlock>
  return;
...
80105661:	a1 94 4f 11 80       	mov    0x80114f94,%eax
{
...
80105673:	83 ec 10             	sub    $0x10,%esp
  ...
  //acquire(&counter_lock);
  argint(0,&x);
80105676:	8d 45 08             	lea    0x8(%ebp),%eax
80105679:	50                   	push   %eax
8010567a:	6a 00                	push   $0x0
8010567c:	e8 cf f0 ff ff       	call   80104750 <argint>
  glob_counter=x;
...
80105684:	83 c4 10             	add    $0x10,%esp
  glob_counter=x;
80105687:	a3 94 4f 11 80       	mov    %eax,0x80114f94
}
8010568c:	c9                   	leave  
8010568d:	c3                   	ret    
8010568e:	66 90                	xchg   %ax,%ax

80105690 <sys_my_futex_lock>:
...
801056a3:	68 a0 4f 11 80       	push   $0x80114fa0
801056a8:	e8 93 ec ff ff       	call   80104340 <acquire>
  release(&tickslock);
801056ad:	c7 04 24 a0 4f 11 80 	movl   $0x80114fa0,(%esp)
  xticks = ticks;
801056b4:	8b 3d e0 57 11 80    	mov    0x801157e0,%edi
  release(&tickslock);
801056ba:	e8 41 ed ff ff       	call   80104400 <release>
  return xticks;
801056bf:	83 c4 10             	add    $0x10,%esp
801056c2:	ba 0a 00 00 00       	mov    $0xa,%edx
  asm volatile("lock; xchgl %0, %1" :
801056c7:	b8 01 00 00 00       	mov    $0x1,%eax
801056cc:	f0 87 05 60 4f 11 80 	lock xchg %eax,0x80114f60
...
801056d5:	75 31                	jne    80105708 <sys_my_futex_lock+0x78>
  acquire(&tickslock);
801056d7:	83 ec 0c             	sub    $0xc,%esp
801056da:	68 a0 4f 11 80       	push   $0x80114fa0
801056df:	e8 5c ec ff ff       	call   80104340 <acquire>
  xticks = ticks;
801056e4:	8b 1d e0 57 11 80    	mov    0x801157e0,%ebx
  release(&tickslock);
801056ea:	c7 04 24 a0 4f 11 80 	movl   $0x80114fa0,(%esp)
801056f1:	e8 0a ed ff ff       	call   80104400 <release>
    }
  //while((xchg(&lk->locked, 1) != 0));
...
801056f6:	8d 65 f4             	lea    -0xc(%ebp),%esp
      tot_time+=(end-st);
801056f9:	29 fb                	sub    %edi,%ebx
801056fb:	8d 04 33             	lea    (%ebx,%esi,1),%eax
}
801056fe:	5b                   	pop    %ebx
801056ff:	5e                   	pop    %esi
80105700:	5f                   	pop    %edi
...
80105704:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(int i=0;i<10;i++)
80105708:	83 ea 01             	sub    $0x1,%edx
8010570b:	75 ba                	jne    801056c7 <sys_my_futex_lock+0x37>
  acquire(&tickslock);
8010570d:	83 ec 0c             	sub    $0xc,%esp
80105710:	68 a0 4f 11 80       	push   $0x80114fa0
80105715:	e8 26 ec ff ff       	call   80104340 <acquire>
  xticks = ticks;
8010571a:	8b 1d e0 57 11 80    	mov    0x801157e0,%ebx
  release(&tickslock);
80105720:	c7 04 24 a0 4f 11 80 	movl   $0x80114fa0,(%esp)
80105727:	e8 d4 ec ff ff       	call   80104400 <release>
      yield();
8010572c:	e8 df e5 ff ff       	call   80103d10 <yield>
      tot_time+=(end-st);
80105731:	29 fb                	sub    %edi,%ebx
    {
80105733:	83 c4 10             	add    $0x10,%esp
      tot_time+=(end-st);
80105736:	01 de                	add    %ebx,%esi
    {
80105738:	e9 63 ff ff ff       	jmp    801056a0 <sys_my_futex_lock+0x10>
8010573d:	8d 76 00             	lea    0x0(%esi),%esi

80105740 <sys_my_lock>:
...
80105748:	68 a0 4f 11 80       	push   $0x80114fa0
8010574d:	e8 ee eb ff ff       	call   80104340 <acquire>
  release(&tickslock);
80105752:	c7 04 24 a0 4f 11 80 	movl   $0x80114fa0,(%esp)
  xticks = ticks;
80105759:	8b 1d e0 57 11 80    	mov    0x801157e0,%ebx
  release(&tickslock);
8010575f:	e8 9c ec ff ff       	call   80104400 <release>
...
80105772:	f0 87 05 60 4f 11 80 	lock xchg %eax,0x80114f60
80105779:	85 c0                	test   %eax,%eax
8010577b:	75 f3                	jne    80105770 <sys_my_lock+0x30>
  acquire(&tickslock);
8010577d:	83 ec 0c             	sub    $0xc,%esp
80105780:	68 a0 4f 11 80       	push   $0x80114fa0
80105785:	e8 b6 eb ff ff       	call   80104340 <acquire>
  xticks = ticks;
8010578a:	8b 35 e0 57 11 80    	mov    0x801157e0,%esi
  release(&tickslock);
80105790:	c7 04 24 a0 4f 11 80 	movl   $0x80114fa0,(%esp)
80105797:	e8 64 ec ff ff       	call   80104400 <release>
  tot_time = sys_uptime()-tot_time;
  return tot_time;
}
8010579c:	8d 65 f8             	lea    -0x8(%ebp),%esp
  tot_time = sys_uptime()-tot_time;
8010579f:	89 f0                	mov    %esi,%eax
801057a1:	29 d8                	sub    %ebx,%eax
}
801057a3:	5b                   	pop    %ebx
801057a4:	5e                   	pop    %esi
801057a5:	5d                   	pop    %ebp
...
801057b1:	89 e5                	mov    %esp,%ebp
  ...
  struct spinlock *lk = &counter_lock;
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801057b3:	c7 05 60 4f 11 80 00 	movl   $0x0,0x80114f60
801057ba:	00 00 00 
  //yield();
  //release(&counter_lock);
  return;
...
801057c0:	06                   	push   %es
  pushl %fs
801057c1:	0f a0                	push   %fs
  pushl %gs
801057c3:	0f a8                	push   %gs
  pushal
801057c5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801057c6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801057ca:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801057cc:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801057ce:	54                   	push   %esp
  call trap
801057cf:	e8 cc 00 00 00       	call   801058a0 <trap>
  addl $4, %esp
801057d4:	83 c4 04             	add    $0x4,%esp
...
801057d7:	61                   	popa   
  popl %gs
801057d8:	0f a9                	pop    %gs
  popl %fs
801057da:	0f a1                	pop    %fs
  popl %es
801057dc:	07                   	pop    %es
  popl %ds
801057dd:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801057de:	83 c4 08             	add    $0x8,%esp
  iret
801057e1:	cf                   	iret   
...
80105807:	c7 04 c5 e2 4f 11 80 	movl   $0x8e000008,-0x7feeb01e(,%eax,8)
8010580e:	08 00 00 8e 
80105812:	66 89 14 c5 e0 4f 11 	mov    %dx,-0x7feeb020(,%eax,8)
80105819:	80 
8010581a:	c1 ea 10             	shr    $0x10,%edx
8010581d:	66 89 14 c5 e6 4f 11 	mov    %dx,-0x7feeb01a(,%eax,8)
80105824:	80 
  for(i = 0; i < 256; i++)
...
80105834:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105837:	c7 05 e2 51 11 80 08 	movl   $0xef000008,0x801151e2
8010583e:	00 00 ef 
  initlock(&tickslock, "time");
80105841:	68 1e 78 10 80       	push   $0x8010781e
80105846:	68 a0 4f 11 80       	push   $0x80114fa0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010584b:	66 a3 e0 51 11 80    	mov    %ax,0x801151e0
80105851:	c1 e8 10             	shr    $0x10,%eax
80105854:	66 a3 e6 51 11 80    	mov    %ax,0x801151e6
  initlock(&tickslock, "time");
8010585a:	e8 a1 e9 ff ff       	call   80104200 <initlock>
}
...
8010587b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010587f:	b8 e0 4f 11 80       	mov    $0x80114fe0,%eax
...
801058c0:	ff 24 85 c4 78 10 80 	jmp    *-0x7fef873c(,%eax,4)
...
801058d0:	e8 0b df ff ff       	call   801037e0 <myproc>
...
801058f0:	e8 cb de ff ff       	call   801037c0 <cpuid>
...
80105901:	e8 da de ff ff       	call   801037e0 <myproc>
...
80105925:	68 80 78 10 80       	push   $0x80107880
8010592a:	e8 31 ad ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010592f:	83 c4 20             	add    $0x20,%esp
80105932:	e8 a9 de ff ff       	call   801037e0 <myproc>
...
8010593e:	e8 9d de ff ff       	call   801037e0 <myproc>
80105943:	85 c0                	test   %eax,%eax
80105945:	74 1d                	je     80105964 <trap+0xc4>
80105947:	e8 94 de ff ff       	call   801037e0 <myproc>
...
80105964:	e8 77 de ff ff       	call   801037e0 <myproc>
80105969:	85 c0                	test   %eax,%eax
8010596b:	74 0b                	je     80105978 <trap+0xd8>
8010596d:	e8 6e de ff ff       	call   801037e0 <myproc>
...
80105976:	74 68                	je     801059e0 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105978:	e8 63 de ff ff       	call   801037e0 <myproc>
8010597d:	85 c0                	test   %eax,%eax
8010597f:	74 19                	je     8010599a <trap+0xfa>
80105981:	e8 5a de ff ff       	call   801037e0 <myproc>
...
801059bd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801059c0:	e8 7b ee ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
801059c5:	e8 16 de ff ff       	call   801037e0 <myproc>
...
80105a14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105a18:	e8 f3 cb ff ff       	call   80102610 <kbdintr>
    lapiceoi();
80105a1d:	e8 2e cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105a38:	e8 53 02 00 00       	call   80105c90 <uartintr>
    lapiceoi();
80105a3d:	e8 0e cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105a5f:	e8 5c dd ff ff       	call   801037c0 <cpuid>
80105a64:	56                   	push   %esi
80105a65:	53                   	push   %ebx
80105a66:	50                   	push   %eax
80105a67:	68 28 78 10 80       	push   $0x80107828
80105a6c:	e8 ef ab ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105a71:	e8 da cc ff ff       	call   80102750 <lapiceoi>
    break;
...
80105a8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105a90:	e8 eb c5 ff ff       	call   80102080 <ideintr>
80105a95:	e9 63 ff ff ff       	jmp    801059fd <trap+0x15d>
80105a9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105aa0:	e8 3b e1 ff ff       	call   80103be0 <exit>
80105aa5:	e9 0e ff ff ff       	jmp    801059b8 <trap+0x118>
80105aaa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105ab0:	e8 2b e1 ff ff       	call   80103be0 <exit>
80105ab5:	e9 aa fe ff ff       	jmp    80105964 <trap+0xc4>
80105aba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105ac0:	83 ec 0c             	sub    $0xc,%esp
80105ac3:	68 a0 4f 11 80       	push   $0x80114fa0
80105ac8:	e8 73 e8 ff ff       	call   80104340 <acquire>
      wakeup(&ticks);
80105acd:	c7 04 24 e0 57 11 80 	movl   $0x801157e0,(%esp)
      ticks++;
80105ad4:	83 05 e0 57 11 80 01 	addl   $0x1,0x801157e0
      wakeup(&ticks);
80105adb:	e8 40 e4 ff ff       	call   80103f20 <wakeup>
      release(&tickslock);
80105ae0:	c7 04 24 a0 4f 11 80 	movl   $0x80114fa0,(%esp)
80105ae7:	e8 14 e9 ff ff       	call   80104400 <release>
80105aec:	83 c4 10             	add    $0x10,%esp
80105aef:	e9 09 ff ff ff       	jmp    801059fd <trap+0x15d>
80105af4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105af7:	e8 c4 dc ff ff       	call   801037c0 <cpuid>
...
80105b05:	68 4c 78 10 80       	push   $0x8010784c
80105b0a:	e8 51 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b0f:	83 c4 14             	add    $0x14,%esp
80105b12:	68 23 78 10 80       	push   $0x80107823
...
80105b75:	e8 f6 cb ff ff       	call   80102770 <microdelay>
...
80105c0c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c0f:	bb 44 79 10 80       	mov    $0x80107944,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c14:	6a 00                	push   $0x0
80105c16:	6a 04                	push   $0x4
80105c18:	e8 b3 c6 ff ff       	call   801022d0 <ioapicenable>
...
80105ca7:	6a 00                	push   $0x0
  jmp alltraps
80105ca9:	e9 11 fb ff ff       	jmp    801057bf <alltraps>
...
80105cb0:	6a 01                	push   $0x1
  jmp alltraps
80105cb2:	e9 08 fb ff ff       	jmp    801057bf <alltraps>
...
80105cb9:	6a 02                	push   $0x2
  jmp alltraps
80105cbb:	e9 ff fa ff ff       	jmp    801057bf <alltraps>
...
80105cc2:	6a 03                	push   $0x3
  jmp alltraps
80105cc4:	e9 f6 fa ff ff       	jmp    801057bf <alltraps>
...
80105ccb:	6a 04                	push   $0x4
  jmp alltraps
80105ccd:	e9 ed fa ff ff       	jmp    801057bf <alltraps>
...
80105cd4:	6a 05                	push   $0x5
  jmp alltraps
80105cd6:	e9 e4 fa ff ff       	jmp    801057bf <alltraps>
...
80105cdd:	6a 06                	push   $0x6
  jmp alltraps
80105cdf:	e9 db fa ff ff       	jmp    801057bf <alltraps>
...
80105ce6:	6a 07                	push   $0x7
  jmp alltraps
80105ce8:	e9 d2 fa ff ff       	jmp    801057bf <alltraps>
...
80105ced:	6a 08                	push   $0x8
  jmp alltraps
80105cef:	e9 cb fa ff ff       	jmp    801057bf <alltraps>
...
80105cf6:	6a 09                	push   $0x9
  jmp alltraps
80105cf8:	e9 c2 fa ff ff       	jmp    801057bf <alltraps>
...
80105cfd:	6a 0a                	push   $0xa
  jmp alltraps
80105cff:	e9 bb fa ff ff       	jmp    801057bf <alltraps>
...
80105d04:	6a 0b                	push   $0xb
  jmp alltraps
80105d06:	e9 b4 fa ff ff       	jmp    801057bf <alltraps>
...
80105d0b:	6a 0c                	push   $0xc
  jmp alltraps
80105d0d:	e9 ad fa ff ff       	jmp    801057bf <alltraps>
...
80105d12:	6a 0d                	push   $0xd
  jmp alltraps
80105d14:	e9 a6 fa ff ff       	jmp    801057bf <alltraps>
...
80105d19:	6a 0e                	push   $0xe
  jmp alltraps
80105d1b:	e9 9f fa ff ff       	jmp    801057bf <alltraps>
...
80105d22:	6a 0f                	push   $0xf
  jmp alltraps
80105d24:	e9 96 fa ff ff       	jmp    801057bf <alltraps>
...
80105d2b:	6a 10                	push   $0x10
  jmp alltraps
80105d2d:	e9 8d fa ff ff       	jmp    801057bf <alltraps>
...
80105d32:	6a 11                	push   $0x11
  jmp alltraps
80105d34:	e9 86 fa ff ff       	jmp    801057bf <alltraps>
...
80105d3b:	6a 12                	push   $0x12
  jmp alltraps
80105d3d:	e9 7d fa ff ff       	jmp    801057bf <alltraps>
...
80105d44:	6a 13                	push   $0x13
  jmp alltraps
80105d46:	e9 74 fa ff ff       	jmp    801057bf <alltraps>
...
80105d4d:	6a 14                	push   $0x14
  jmp alltraps
80105d4f:	e9 6b fa ff ff       	jmp    801057bf <alltraps>
...
80105d56:	6a 15                	push   $0x15
  jmp alltraps
80105d58:	e9 62 fa ff ff       	jmp    801057bf <alltraps>
...
80105d5f:	6a 16                	push   $0x16
  jmp alltraps
80105d61:	e9 59 fa ff ff       	jmp    801057bf <alltraps>
...
80105d68:	6a 17                	push   $0x17
  jmp alltraps
80105d6a:	e9 50 fa ff ff       	jmp    801057bf <alltraps>
...
80105d71:	6a 18                	push   $0x18
  jmp alltraps
80105d73:	e9 47 fa ff ff       	jmp    801057bf <alltraps>
...
80105d7a:	6a 19                	push   $0x19
  jmp alltraps
80105d7c:	e9 3e fa ff ff       	jmp    801057bf <alltraps>
...
80105d83:	6a 1a                	push   $0x1a
  jmp alltraps
80105d85:	e9 35 fa ff ff       	jmp    801057bf <alltraps>
...
80105d8c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d8e:	e9 2c fa ff ff       	jmp    801057bf <alltraps>
...
80105d95:	6a 1c                	push   $0x1c
  jmp alltraps
80105d97:	e9 23 fa ff ff       	jmp    801057bf <alltraps>
...
80105d9e:	6a 1d                	push   $0x1d
  jmp alltraps
80105da0:	e9 1a fa ff ff       	jmp    801057bf <alltraps>
...
80105da7:	6a 1e                	push   $0x1e
  jmp alltraps
80105da9:	e9 11 fa ff ff       	jmp    801057bf <alltraps>
...
80105db0:	6a 1f                	push   $0x1f
  jmp alltraps
80105db2:	e9 08 fa ff ff       	jmp    801057bf <alltraps>
...
80105db9:	6a 20                	push   $0x20
  jmp alltraps
80105dbb:	e9 ff f9 ff ff       	jmp    801057bf <alltraps>
...
80105dc2:	6a 21                	push   $0x21
  jmp alltraps
80105dc4:	e9 f6 f9 ff ff       	jmp    801057bf <alltraps>
...
80105dcb:	6a 22                	push   $0x22
  jmp alltraps
80105dcd:	e9 ed f9 ff ff       	jmp    801057bf <alltraps>
...
80105dd4:	6a 23                	push   $0x23
  jmp alltraps
80105dd6:	e9 e4 f9 ff ff       	jmp    801057bf <alltraps>
...
80105ddd:	6a 24                	push   $0x24
  jmp alltraps
80105ddf:	e9 db f9 ff ff       	jmp    801057bf <alltraps>
...
80105de6:	6a 25                	push   $0x25
  jmp alltraps
80105de8:	e9 d2 f9 ff ff       	jmp    801057bf <alltraps>
...
80105def:	6a 26                	push   $0x26
  jmp alltraps
80105df1:	e9 c9 f9 ff ff       	jmp    801057bf <alltraps>
...
80105df8:	6a 27                	push   $0x27
  jmp alltraps
80105dfa:	e9 c0 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e01:	6a 28                	push   $0x28
  jmp alltraps
80105e03:	e9 b7 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e0a:	6a 29                	push   $0x29
  jmp alltraps
80105e0c:	e9 ae f9 ff ff       	jmp    801057bf <alltraps>
...
80105e13:	6a 2a                	push   $0x2a
  jmp alltraps
80105e15:	e9 a5 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e1c:	6a 2b                	push   $0x2b
  jmp alltraps
80105e1e:	e9 9c f9 ff ff       	jmp    801057bf <alltraps>
...
80105e25:	6a 2c                	push   $0x2c
  jmp alltraps
80105e27:	e9 93 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e2e:	6a 2d                	push   $0x2d
  jmp alltraps
80105e30:	e9 8a f9 ff ff       	jmp    801057bf <alltraps>
...
80105e37:	6a 2e                	push   $0x2e
  jmp alltraps
80105e39:	e9 81 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e40:	6a 2f                	push   $0x2f
  jmp alltraps
80105e42:	e9 78 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e49:	6a 30                	push   $0x30
  jmp alltraps
80105e4b:	e9 6f f9 ff ff       	jmp    801057bf <alltraps>
...
80105e52:	6a 31                	push   $0x31
  jmp alltraps
80105e54:	e9 66 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e5b:	6a 32                	push   $0x32
  jmp alltraps
80105e5d:	e9 5d f9 ff ff       	jmp    801057bf <alltraps>
...
80105e64:	6a 33                	push   $0x33
  jmp alltraps
80105e66:	e9 54 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e6d:	6a 34                	push   $0x34
  jmp alltraps
80105e6f:	e9 4b f9 ff ff       	jmp    801057bf <alltraps>
...
80105e76:	6a 35                	push   $0x35
  jmp alltraps
80105e78:	e9 42 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e7f:	6a 36                	push   $0x36
  jmp alltraps
80105e81:	e9 39 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e88:	6a 37                	push   $0x37
  jmp alltraps
80105e8a:	e9 30 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e91:	6a 38                	push   $0x38
  jmp alltraps
80105e93:	e9 27 f9 ff ff       	jmp    801057bf <alltraps>
...
80105e9a:	6a 39                	push   $0x39
  jmp alltraps
80105e9c:	e9 1e f9 ff ff       	jmp    801057bf <alltraps>
...
80105ea3:	6a 3a                	push   $0x3a
  jmp alltraps
80105ea5:	e9 15 f9 ff ff       	jmp    801057bf <alltraps>
...
80105eac:	6a 3b                	push   $0x3b
  jmp alltraps
80105eae:	e9 0c f9 ff ff       	jmp    801057bf <alltraps>
...
80105eb5:	6a 3c                	push   $0x3c
  jmp alltraps
80105eb7:	e9 03 f9 ff ff       	jmp    801057bf <alltraps>
...
80105ebe:	6a 3d                	push   $0x3d
  jmp alltraps
80105ec0:	e9 fa f8 ff ff       	jmp    801057bf <alltraps>
...
80105ec7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ec9:	e9 f1 f8 ff ff       	jmp    801057bf <alltraps>
...
80105ed0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ed2:	e9 e8 f8 ff ff       	jmp    801057bf <alltraps>
...
80105ed9:	6a 40                	push   $0x40
  jmp alltraps
80105edb:	e9 df f8 ff ff       	jmp    801057bf <alltraps>
...
80105ee2:	6a 41                	push   $0x41
  jmp alltraps
80105ee4:	e9 d6 f8 ff ff       	jmp    801057bf <alltraps>
...
80105eeb:	6a 42                	push   $0x42
  jmp alltraps
80105eed:	e9 cd f8 ff ff       	jmp    801057bf <alltraps>
...
80105ef4:	6a 43                	push   $0x43
  jmp alltraps
80105ef6:	e9 c4 f8 ff ff       	jmp    801057bf <alltraps>
...
80105efd:	6a 44                	push   $0x44
  jmp alltraps
80105eff:	e9 bb f8 ff ff       	jmp    801057bf <alltraps>
...
80105f06:	6a 45                	push   $0x45
  jmp alltraps
80105f08:	e9 b2 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f0f:	6a 46                	push   $0x46
  jmp alltraps
80105f11:	e9 a9 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f18:	6a 47                	push   $0x47
  jmp alltraps
80105f1a:	e9 a0 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f21:	6a 48                	push   $0x48
  jmp alltraps
80105f23:	e9 97 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f2a:	6a 49                	push   $0x49
  jmp alltraps
80105f2c:	e9 8e f8 ff ff       	jmp    801057bf <alltraps>
...
80105f33:	6a 4a                	push   $0x4a
  jmp alltraps
80105f35:	e9 85 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f3c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f3e:	e9 7c f8 ff ff       	jmp    801057bf <alltraps>
...
80105f45:	6a 4c                	push   $0x4c
  jmp alltraps
80105f47:	e9 73 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f4e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f50:	e9 6a f8 ff ff       	jmp    801057bf <alltraps>
...
80105f57:	6a 4e                	push   $0x4e
  jmp alltraps
80105f59:	e9 61 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f60:	6a 4f                	push   $0x4f
  jmp alltraps
80105f62:	e9 58 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f69:	6a 50                	push   $0x50
  jmp alltraps
80105f6b:	e9 4f f8 ff ff       	jmp    801057bf <alltraps>
...
80105f72:	6a 51                	push   $0x51
  jmp alltraps
80105f74:	e9 46 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f7b:	6a 52                	push   $0x52
  jmp alltraps
80105f7d:	e9 3d f8 ff ff       	jmp    801057bf <alltraps>
...
80105f84:	6a 53                	push   $0x53
  jmp alltraps
80105f86:	e9 34 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f8d:	6a 54                	push   $0x54
  jmp alltraps
80105f8f:	e9 2b f8 ff ff       	jmp    801057bf <alltraps>
...
80105f96:	6a 55                	push   $0x55
  jmp alltraps
80105f98:	e9 22 f8 ff ff       	jmp    801057bf <alltraps>
...
80105f9f:	6a 56                	push   $0x56
  jmp alltraps
80105fa1:	e9 19 f8 ff ff       	jmp    801057bf <alltraps>
...
80105fa8:	6a 57                	push   $0x57
  jmp alltraps
80105faa:	e9 10 f8 ff ff       	jmp    801057bf <alltraps>
...
80105fb1:	6a 58                	push   $0x58
  jmp alltraps
80105fb3:	e9 07 f8 ff ff       	jmp    801057bf <alltraps>
...
80105fba:	6a 59                	push   $0x59
  jmp alltraps
80105fbc:	e9 fe f7 ff ff       	jmp    801057bf <alltraps>
...
80105fc3:	6a 5a                	push   $0x5a
  jmp alltraps
80105fc5:	e9 f5 f7 ff ff       	jmp    801057bf <alltraps>
...
80105fcc:	6a 5b                	push   $0x5b
  jmp alltraps
80105fce:	e9 ec f7 ff ff       	jmp    801057bf <alltraps>
...
80105fd5:	6a 5c                	push   $0x5c
  jmp alltraps
80105fd7:	e9 e3 f7 ff ff       	jmp    801057bf <alltraps>
...
80105fde:	6a 5d                	push   $0x5d
  jmp alltraps
80105fe0:	e9 da f7 ff ff       	jmp    801057bf <alltraps>
...
80105fe7:	6a 5e                	push   $0x5e
  jmp alltraps
80105fe9:	e9 d1 f7 ff ff       	jmp    801057bf <alltraps>
...
80105ff0:	6a 5f                	push   $0x5f
  jmp alltraps
80105ff2:	e9 c8 f7 ff ff       	jmp    801057bf <alltraps>
...
80105ff9:	6a 60                	push   $0x60
  jmp alltraps
80105ffb:	e9 bf f7 ff ff       	jmp    801057bf <alltraps>
...
80106002:	6a 61                	push   $0x61
  jmp alltraps
80106004:	e9 b6 f7 ff ff       	jmp    801057bf <alltraps>
...
8010600b:	6a 62                	push   $0x62
  jmp alltraps
8010600d:	e9 ad f7 ff ff       	jmp    801057bf <alltraps>
...
80106014:	6a 63                	push   $0x63
  jmp alltraps
80106016:	e9 a4 f7 ff ff       	jmp    801057bf <alltraps>
...
8010601d:	6a 64                	push   $0x64
  jmp alltraps
8010601f:	e9 9b f7 ff ff       	jmp    801057bf <alltraps>
...
80106026:	6a 65                	push   $0x65
  jmp alltraps
80106028:	e9 92 f7 ff ff       	jmp    801057bf <alltraps>
...
8010602f:	6a 66                	push   $0x66
  jmp alltraps
80106031:	e9 89 f7 ff ff       	jmp    801057bf <alltraps>
...
80106038:	6a 67                	push   $0x67
  jmp alltraps
8010603a:	e9 80 f7 ff ff       	jmp    801057bf <alltraps>
...
80106041:	6a 68                	push   $0x68
  jmp alltraps
80106043:	e9 77 f7 ff ff       	jmp    801057bf <alltraps>
...
8010604a:	6a 69                	push   $0x69
  jmp alltraps
8010604c:	e9 6e f7 ff ff       	jmp    801057bf <alltraps>
...
80106053:	6a 6a                	push   $0x6a
  jmp alltraps
80106055:	e9 65 f7 ff ff       	jmp    801057bf <alltraps>
...
8010605c:	6a 6b                	push   $0x6b
  jmp alltraps
8010605e:	e9 5c f7 ff ff       	jmp    801057bf <alltraps>
...
80106065:	6a 6c                	push   $0x6c
  jmp alltraps
80106067:	e9 53 f7 ff ff       	jmp    801057bf <alltraps>
...
8010606e:	6a 6d                	push   $0x6d
  jmp alltraps
80106070:	e9 4a f7 ff ff       	jmp    801057bf <alltraps>
...
80106077:	6a 6e                	push   $0x6e
  jmp alltraps
80106079:	e9 41 f7 ff ff       	jmp    801057bf <alltraps>
...
80106080:	6a 6f                	push   $0x6f
  jmp alltraps
80106082:	e9 38 f7 ff ff       	jmp    801057bf <alltraps>
...
80106089:	6a 70                	push   $0x70
  jmp alltraps
8010608b:	e9 2f f7 ff ff       	jmp    801057bf <alltraps>
...
80106092:	6a 71                	push   $0x71
  jmp alltraps
80106094:	e9 26 f7 ff ff       	jmp    801057bf <alltraps>
...
8010609b:	6a 72                	push   $0x72
  jmp alltraps
8010609d:	e9 1d f7 ff ff       	jmp    801057bf <alltraps>
...
801060a4:	6a 73                	push   $0x73
  jmp alltraps
801060a6:	e9 14 f7 ff ff       	jmp    801057bf <alltraps>
...
801060ad:	6a 74                	push   $0x74
  jmp alltraps
801060af:	e9 0b f7 ff ff       	jmp    801057bf <alltraps>
...
801060b6:	6a 75                	push   $0x75
  jmp alltraps
801060b8:	e9 02 f7 ff ff       	jmp    801057bf <alltraps>
...
801060bf:	6a 76                	push   $0x76
  jmp alltraps
801060c1:	e9 f9 f6 ff ff       	jmp    801057bf <alltraps>
...
801060c8:	6a 77                	push   $0x77
  jmp alltraps
801060ca:	e9 f0 f6 ff ff       	jmp    801057bf <alltraps>
...
801060d1:	6a 78                	push   $0x78
  jmp alltraps
801060d3:	e9 e7 f6 ff ff       	jmp    801057bf <alltraps>
...
801060da:	6a 79                	push   $0x79
  jmp alltraps
801060dc:	e9 de f6 ff ff       	jmp    801057bf <alltraps>
...
801060e3:	6a 7a                	push   $0x7a
  jmp alltraps
801060e5:	e9 d5 f6 ff ff       	jmp    801057bf <alltraps>
...
801060ec:	6a 7b                	push   $0x7b
  jmp alltraps
801060ee:	e9 cc f6 ff ff       	jmp    801057bf <alltraps>
...
801060f5:	6a 7c                	push   $0x7c
  jmp alltraps
801060f7:	e9 c3 f6 ff ff       	jmp    801057bf <alltraps>
...
801060fe:	6a 7d                	push   $0x7d
  jmp alltraps
80106100:	e9 ba f6 ff ff       	jmp    801057bf <alltraps>
...
80106107:	6a 7e                	push   $0x7e
  jmp alltraps
80106109:	e9 b1 f6 ff ff       	jmp    801057bf <alltraps>
...
80106110:	6a 7f                	push   $0x7f
  jmp alltraps
80106112:	e9 a8 f6 ff ff       	jmp    801057bf <alltraps>
...
80106119:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010611e:	e9 9c f6 ff ff       	jmp    801057bf <alltraps>
...
80106125:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010612a:	e9 90 f6 ff ff       	jmp    801057bf <alltraps>
...
80106131:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106136:	e9 84 f6 ff ff       	jmp    801057bf <alltraps>
...
8010613d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106142:	e9 78 f6 ff ff       	jmp    801057bf <alltraps>
...
80106149:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010614e:	e9 6c f6 ff ff       	jmp    801057bf <alltraps>
...
80106155:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010615a:	e9 60 f6 ff ff       	jmp    801057bf <alltraps>
...
80106161:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106166:	e9 54 f6 ff ff       	jmp    801057bf <alltraps>
...
8010616d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106172:	e9 48 f6 ff ff       	jmp    801057bf <alltraps>
...
80106179:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010617e:	e9 3c f6 ff ff       	jmp    801057bf <alltraps>
...
80106185:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010618a:	e9 30 f6 ff ff       	jmp    801057bf <alltraps>
...
80106191:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106196:	e9 24 f6 ff ff       	jmp    801057bf <alltraps>
...
8010619d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061a2:	e9 18 f6 ff ff       	jmp    801057bf <alltraps>
...
801061a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061ae:	e9 0c f6 ff ff       	jmp    801057bf <alltraps>
...
801061b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061ba:	e9 00 f6 ff ff       	jmp    801057bf <alltraps>
...
801061c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801061c6:	e9 f4 f5 ff ff       	jmp    801057bf <alltraps>
...
801061cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801061d2:	e9 e8 f5 ff ff       	jmp    801057bf <alltraps>
...
801061d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801061de:	e9 dc f5 ff ff       	jmp    801057bf <alltraps>
...
801061e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801061ea:	e9 d0 f5 ff ff       	jmp    801057bf <alltraps>
...
801061f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801061f6:	e9 c4 f5 ff ff       	jmp    801057bf <alltraps>
...
801061fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106202:	e9 b8 f5 ff ff       	jmp    801057bf <alltraps>
...
80106209:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010620e:	e9 ac f5 ff ff       	jmp    801057bf <alltraps>
...
80106215:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010621a:	e9 a0 f5 ff ff       	jmp    801057bf <alltraps>
...
80106221:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106226:	e9 94 f5 ff ff       	jmp    801057bf <alltraps>
...
8010622d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106232:	e9 88 f5 ff ff       	jmp    801057bf <alltraps>
...
80106239:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010623e:	e9 7c f5 ff ff       	jmp    801057bf <alltraps>
...
80106245:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010624a:	e9 70 f5 ff ff       	jmp    801057bf <alltraps>
...
80106251:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106256:	e9 64 f5 ff ff       	jmp    801057bf <alltraps>
...
8010625d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106262:	e9 58 f5 ff ff       	jmp    801057bf <alltraps>
...
80106269:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010626e:	e9 4c f5 ff ff       	jmp    801057bf <alltraps>
...
80106275:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010627a:	e9 40 f5 ff ff       	jmp    801057bf <alltraps>
...
80106281:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106286:	e9 34 f5 ff ff       	jmp    801057bf <alltraps>
...
8010628d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106292:	e9 28 f5 ff ff       	jmp    801057bf <alltraps>
...
80106299:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010629e:	e9 1c f5 ff ff       	jmp    801057bf <alltraps>
...
801062a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062aa:	e9 10 f5 ff ff       	jmp    801057bf <alltraps>
...
801062b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062b6:	e9 04 f5 ff ff       	jmp    801057bf <alltraps>
...
801062bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801062c2:	e9 f8 f4 ff ff       	jmp    801057bf <alltraps>
...
801062c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801062ce:	e9 ec f4 ff ff       	jmp    801057bf <alltraps>
...
801062d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801062da:	e9 e0 f4 ff ff       	jmp    801057bf <alltraps>
...
801062e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801062e6:	e9 d4 f4 ff ff       	jmp    801057bf <alltraps>
...
801062ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801062f2:	e9 c8 f4 ff ff       	jmp    801057bf <alltraps>
...
801062f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801062fe:	e9 bc f4 ff ff       	jmp    801057bf <alltraps>
...
80106305:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010630a:	e9 b0 f4 ff ff       	jmp    801057bf <alltraps>
...
80106311:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106316:	e9 a4 f4 ff ff       	jmp    801057bf <alltraps>
...
8010631d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106322:	e9 98 f4 ff ff       	jmp    801057bf <alltraps>
...
80106329:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010632e:	e9 8c f4 ff ff       	jmp    801057bf <alltraps>
...
80106335:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010633a:	e9 80 f4 ff ff       	jmp    801057bf <alltraps>
...
80106341:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106346:	e9 74 f4 ff ff       	jmp    801057bf <alltraps>
...
8010634d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106352:	e9 68 f4 ff ff       	jmp    801057bf <alltraps>
...
80106359:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010635e:	e9 5c f4 ff ff       	jmp    801057bf <alltraps>
...
80106365:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010636a:	e9 50 f4 ff ff       	jmp    801057bf <alltraps>
...
80106371:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106376:	e9 44 f4 ff ff       	jmp    801057bf <alltraps>
...
8010637d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106382:	e9 38 f4 ff ff       	jmp    801057bf <alltraps>
...
80106389:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010638e:	e9 2c f4 ff ff       	jmp    801057bf <alltraps>
...
80106395:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010639a:	e9 20 f4 ff ff       	jmp    801057bf <alltraps>
...
801063a1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063a6:	e9 14 f4 ff ff       	jmp    801057bf <alltraps>
...
801063ad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063b2:	e9 08 f4 ff ff       	jmp    801057bf <alltraps>
...
801063b9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063be:	e9 fc f3 ff ff       	jmp    801057bf <alltraps>
...
801063c5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801063ca:	e9 f0 f3 ff ff       	jmp    801057bf <alltraps>
...
801063d1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801063d6:	e9 e4 f3 ff ff       	jmp    801057bf <alltraps>
...
801063dd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801063e2:	e9 d8 f3 ff ff       	jmp    801057bf <alltraps>
...
801063e9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801063ee:	e9 cc f3 ff ff       	jmp    801057bf <alltraps>
...
801063f5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801063fa:	e9 c0 f3 ff ff       	jmp    801057bf <alltraps>
...
80106401:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106406:	e9 b4 f3 ff ff       	jmp    801057bf <alltraps>
...
8010640d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106412:	e9 a8 f3 ff ff       	jmp    801057bf <alltraps>
...
80106419:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010641e:	e9 9c f3 ff ff       	jmp    801057bf <alltraps>
...
80106425:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010642a:	e9 90 f3 ff ff       	jmp    801057bf <alltraps>
...
80106431:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106436:	e9 84 f3 ff ff       	jmp    801057bf <alltraps>
...
8010643d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106442:	e9 78 f3 ff ff       	jmp    801057bf <alltraps>
...
80106449:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010644e:	e9 6c f3 ff ff       	jmp    801057bf <alltraps>
...
80106455:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010645a:	e9 60 f3 ff ff       	jmp    801057bf <alltraps>
...
80106461:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106466:	e9 54 f3 ff ff       	jmp    801057bf <alltraps>
...
8010646d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106472:	e9 48 f3 ff ff       	jmp    801057bf <alltraps>
...
80106479:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010647e:	e9 3c f3 ff ff       	jmp    801057bf <alltraps>
...
80106485:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010648a:	e9 30 f3 ff ff       	jmp    801057bf <alltraps>
...
80106491:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106496:	e9 24 f3 ff ff       	jmp    801057bf <alltraps>
...
8010649d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064a2:	e9 18 f3 ff ff       	jmp    801057bf <alltraps>
...
801064a9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064ae:	e9 0c f3 ff ff       	jmp    801057bf <alltraps>
...
801064b5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064ba:	e9 00 f3 ff ff       	jmp    801057bf <alltraps>
...
801064c1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801064c6:	e9 f4 f2 ff ff       	jmp    801057bf <alltraps>
...
801064cd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801064d2:	e9 e8 f2 ff ff       	jmp    801057bf <alltraps>
...
801064d9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801064de:	e9 dc f2 ff ff       	jmp    801057bf <alltraps>
...
801064e5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801064ea:	e9 d0 f2 ff ff       	jmp    801057bf <alltraps>
...
801064f1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801064f6:	e9 c4 f2 ff ff       	jmp    801057bf <alltraps>
...
801064fd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106502:	e9 b8 f2 ff ff       	jmp    801057bf <alltraps>
...
80106509:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010650e:	e9 ac f2 ff ff       	jmp    801057bf <alltraps>
...
80106515:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010651a:	e9 a0 f2 ff ff       	jmp    801057bf <alltraps>
...
80106521:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106526:	e9 94 f2 ff ff       	jmp    801057bf <alltraps>
...
8010652d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106532:	e9 88 f2 ff ff       	jmp    801057bf <alltraps>
...
80106539:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010653e:	e9 7c f2 ff ff       	jmp    801057bf <alltraps>
...
80106545:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010654a:	e9 70 f2 ff ff       	jmp    801057bf <alltraps>
...
80106551:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106556:	e9 64 f2 ff ff       	jmp    801057bf <alltraps>
...
8010655d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106562:	e9 58 f2 ff ff       	jmp    801057bf <alltraps>
...
80106569:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010656e:	e9 4c f2 ff ff       	jmp    801057bf <alltraps>
...
80106575:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010657a:	e9 40 f2 ff ff       	jmp    801057bf <alltraps>
...
80106581:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106586:	e9 34 f2 ff ff       	jmp    801057bf <alltraps>
...
8010658d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106592:	e9 28 f2 ff ff       	jmp    801057bf <alltraps>
...
80106599:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010659e:	e9 1c f2 ff ff       	jmp    801057bf <alltraps>
...
801065a5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065aa:	e9 10 f2 ff ff       	jmp    801057bf <alltraps>
...
801065b1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065b6:	e9 04 f2 ff ff       	jmp    801057bf <alltraps>
...
801065bd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801065c2:	e9 f8 f1 ff ff       	jmp    801057bf <alltraps>
...
801065c9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801065ce:	e9 ec f1 ff ff       	jmp    801057bf <alltraps>
...
801065d5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801065da:	e9 e0 f1 ff ff       	jmp    801057bf <alltraps>
...
801065e1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801065e6:	e9 d4 f1 ff ff       	jmp    801057bf <alltraps>
...
801065ed:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801065f2:	e9 c8 f1 ff ff       	jmp    801057bf <alltraps>
...
801065f9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801065fe:	e9 bc f1 ff ff       	jmp    801057bf <alltraps>
...
80106605:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010660a:	e9 b0 f1 ff ff       	jmp    801057bf <alltraps>
...
80106611:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106616:	e9 a4 f1 ff ff       	jmp    801057bf <alltraps>
...
8010661d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106622:	e9 98 f1 ff ff       	jmp    801057bf <alltraps>
...
80106629:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010662e:	e9 8c f1 ff ff       	jmp    801057bf <alltraps>
...
80106635:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010663a:	e9 80 f1 ff ff       	jmp    801057bf <alltraps>
...
80106641:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106646:	e9 74 f1 ff ff       	jmp    801057bf <alltraps>
...
8010664d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106652:	e9 68 f1 ff ff       	jmp    801057bf <alltraps>
...
80106659:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010665e:	e9 5c f1 ff ff       	jmp    801057bf <alltraps>
...
80106665:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010666a:	e9 50 f1 ff ff       	jmp    801057bf <alltraps>
...
80106671:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106676:	e9 44 f1 ff ff       	jmp    801057bf <alltraps>
...
8010667d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106682:	e9 38 f1 ff ff       	jmp    801057bf <alltraps>
...
80106689:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010668e:	e9 2c f1 ff ff       	jmp    801057bf <alltraps>
...
80106695:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010669a:	e9 20 f1 ff ff       	jmp    801057bf <alltraps>
...
801066a1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066a6:	e9 14 f1 ff ff       	jmp    801057bf <alltraps>
...
801066ad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066b2:	e9 08 f1 ff ff       	jmp    801057bf <alltraps>
...
801066b9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066be:	e9 fc f0 ff ff       	jmp    801057bf <alltraps>
...
801066c5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066ca:	e9 f0 f0 ff ff       	jmp    801057bf <alltraps>
...
801066d1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066d6:	e9 e4 f0 ff ff       	jmp    801057bf <alltraps>
...
801066dd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801066e2:	e9 d8 f0 ff ff       	jmp    801057bf <alltraps>
...
801066e9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066ee:	e9 cc f0 ff ff       	jmp    801057bf <alltraps>
...
801066f5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066fa:	e9 c0 f0 ff ff       	jmp    801057bf <alltraps>
...
80106701:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106706:	e9 b4 f0 ff ff       	jmp    801057bf <alltraps>
...
8010670d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106712:	e9 a8 f0 ff ff       	jmp    801057bf <alltraps>
...
80106764:	e8 57 bd ff ff       	call   801024c0 <kalloc>
...
8010677a:	e8 d1 dc ff ff       	call   80104450 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010681d:	68 4c 79 10 80       	push   $0x8010794c
...
80106874:	e8 97 ba ff ff       	call   80102310 <kfree>
      *pte = 0;
...
801068d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801068d6:	e8 e5 ce ff ff       	call   801037c0 <cpuid>
...
80106960:	a1 e4 57 11 80       	mov    0x801157e4,%eax
{
...
801069a4:	0f 84 c2 00 00 00    	je     80106a6c <switchuvm+0xec>
  pushcli();
801069aa:	e8 c1 d8 ff ff       	call   80104270 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069af:	e8 8c cd ff ff       	call   80103740 <mycpu>
801069b4:	89 c6                	mov    %eax,%esi
801069b6:	e8 85 cd ff ff       	call   80103740 <mycpu>
...
801069c8:	e8 73 cd ff ff       	call   80103740 <mycpu>
...
80106a11:	e8 2a cd ff ff       	call   80103740 <mycpu>
...
80106a29:	e8 12 cd ff ff       	call   80103740 <mycpu>
80106a2e:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106a34:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a37:	e8 04 cd ff ff       	call   80103740 <mycpu>
...
80106aab:	77 49                	ja     80106af6 <inituvm+0x66>
  mem = kalloc();
80106aad:	e8 0e ba ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106abf:	e8 8c d9 ff ff       	call   80104450 <memset>
...
80106af0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106af1:	e9 0a da ff ff       	jmp    80104500 <memmove>
    panic("inituvm: more than a page");
80106af6:	83 ec 0c             	sub    $0xc,%esp
80106af9:	68 91 79 10 80       	push   $0x80107991
...
80106b81:	e8 da ad ff ff       	call   80101960 <readi>
...
80106c1b:	e8 30 d8 ff ff       	call   80104450 <memset>
...
80106c49:	0f 86 81 00 00 00    	jbe    80106cd0 <allocuvm+0x100>
    mem = kalloc();
80106c4f:	e8 6c b8 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106c5d:	68 c9 79 10 80       	push   $0x801079c9
...
80106c93:	68 e1 79 10 80       	push   $0x801079e1
...
80106cbb:	e8 50 b6 ff ff       	call   80102310 <kfree>
      return 0;
...
80106d7e:	e8 8d b5 ff ff       	call   80102310 <kfree>
...
80106d93:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106d94:	e9 77 b5 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106d99:	83 ec 0c             	sub    $0xc,%esp
80106d9c:	68 fd 79 10 80       	push   $0x801079fd
...
80106db5:	e8 06 b7 ff ff       	call   801024c0 <kalloc>
...
80106e3b:	a3 e4 57 11 80       	mov    %eax,0x801157e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e6f:	68 0e 7a 10 80       	push   $0x80107a0e
...
80106f15:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106f18:	e8 a3 b5 ff ff       	call   801024c0 <kalloc>
...
80106fef:	e8 0c d5 ff ff       	call   80104500 <memmove>
    len -= n;
    buf += n;
